...
## 4. PORT
- 한 클라이언트에서 복수의 서버와 소통해야 한다면?
- TCP/IP 패킷 안에 출발/목적지의 IP + PORT를 첨부함
- 즉, 같은 IP 내에서 프로세스를 구분해 줌
- IP가 아파트라면, PORT는 몇동 몇호인지!

## 5. DNS (Domain Name System)
- IP는 기억하기 어렵고, 변경될 수 있음
- DNS 서버에 도메인 명과 IP 주소를 저장해두고, 도메인을 통해 IP를 간접적으로 사용함